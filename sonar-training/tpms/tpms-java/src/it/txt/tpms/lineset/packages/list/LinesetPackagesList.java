 ...
 * 
 */
public class LinesetPackagesList {
    ...
    private class AlphabeticalSortByLinsetName implements Comparator {
        ...
        public int compare(Object obj1, Object obj2) {
            ...
            if (obj1 != null && obj2 != null) {
                ...
                String s1 = ((LinesetPackage) obj1).getLinesetName().toLowerCase();
                String s2 = ((LinesetPackage) obj2).getLinesetName().toLowerCase();
    ...
    private ArrayList getSortedLinesetPackagesArrayList() {
        ...
        Collections.sort(arrLst, new AlphabeticalSortByLinsetName());
        return arrLst;
    }
     ...
     */
    public int addElement(LinesetPackage linesetPackage) {
     ...
     * @return OK_RESULT, if the operation succeed, KO_RESULT otherwise (i.e. the given installationData key is null or empty)
     */
    public int removeElement(LinesetPackage linesetPackage) {
        if (linesetPackage != null && !GeneralStringUtils.isEmptyString(linesetPackage.getLinesetPackageId())) {
    ...
    public boolean containsLinesetPackage(String linesetPackageId) {
        if (!GeneralStringUtils.isEmptyString(linesetPackageId) && linesetPackagesList != null) {
            return linesetPackagesList.containsKey(linesetPackageId);
        }
        return false;
    }
     ...
     */
    public boolean containsLinesetPackage(LinesetPackage linesetPackage) {
        if (linesetPackage != null && linesetPackagesList != null) {
            return linesetPackagesList.containsValue(linesetPackage);
        }
        return false;
    }
     ...
     *
     * @param linesetPackageId
     * @return the installationData identified by the given element installationId
     */
    public LinesetPackage getElement(String linesetPackageId) {
        if (linesetPackagesList != null && !GeneralStringUtils.isEmptyString(linesetPackageId)) {
            return (LinesetPackage) linesetPackagesList.get(linesetPackageId);
        }
        return null;
    }
     ...
     */
    public LinesetPackage next() {
        if (packagesListIterator == null) {
            packagesListIterator = getSortedLinesetPackagesListIterator();
        }
        return (LinesetPackage) packagesListIterator.next();
    }
