...
import com.st.mavenxxs.jsf.util.JsfUtil;
import com.st.mavenxxs.jsf.util.PaginationHelper;
import com.st.mavenxxs.jpa.session.UserFacade;
...
public class UserController implements Serializable {
    ...
    @EJB
    private com.st.mavenxxs.jpa.session.UserFacade ejbFacade;
