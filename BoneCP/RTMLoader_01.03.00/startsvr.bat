...
set RTM_PATH="C:\CC_Projects\<name>_RTMd_loader_view\dev_RTM\RTMLoader"
...
set RTM_LIB_PATDBAPP=%RTM_LIB_PATH%\rtmloader.jar
set RTM_LIB_ACTIVATION=%RTM_LIB_PATH%\activation.jar
set RTM_LIB_CCAM=%RTM_LIB_PATH%\CCAMFramework.jar
...
set COMMON_LIB=%RTM_LIB_PATDBAPP%;%RTM_LIB_ACTIVATION%;%RTM_LIB_CCAM%;%RTM_LIB_NET%;%RTM_LIB_LANG%;%RTM_LIB_LOG%;%RTM_LIB_MAIL%;%RTM_LIB_ORACLE10%;%RTM_LIB_IO%
rem ***********************
rem ****** LANCEMENT ******
rem ***********************
