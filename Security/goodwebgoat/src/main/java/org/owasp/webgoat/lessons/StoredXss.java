...
public class StoredXss extends LessonAdapter {
    ...
    protected Element makeCurrent(WebSession s) {
        ...
        try {
            ...
            if ((results != null) && results.first()) {
                ...
                /* Start Good Code */
                String messageData = HtmlEncoder.encode(results.getString(MESSAGE_COL));
                /* End Good Code */
    ...
    protected Element makeInput(WebSession s) {
        ...
        TR rowImage = new TR();
        rowImage.addElement(new TD().addElement(new IMG("images/ST/secure.jpg").setWidth(38).setHeight(20)));

        TR row3 = new TR();
        row3.addElement(new TD().addElement(WebGoatI18N.get("StoredXssHint3")).setColSpan(2));

        TR row4 = new TR();
        row4.addElement(new TD().addElement("Next " + WebGoatI18N.get("StoredXssHint4")).setColSpan(2));
