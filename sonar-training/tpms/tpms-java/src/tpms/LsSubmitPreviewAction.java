...
public class LsSubmitPreviewAction extends LsAction {

    public LsSubmitPreviewAction(String action, LogWriter log) {
        super(action, log);
    ...
    public void writeBackEndInFile(String SID, String fName, String repFileName) throws IOException, Exception {
        ...
        out.println("unix_home=" + xmlRdr.getVal(lsRec, "HOME_DIR"));
        out.println("in_dir=" + xmlRdr.getVal(lsRec, "SYNCRODIR"));
        out.println("tst_family=" + xmlRdr.getVal(lsRec, "TESTERFAM"));
