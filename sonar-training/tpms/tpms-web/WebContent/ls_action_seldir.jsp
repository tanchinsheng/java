...
<%
         ...
         String linesetName=(String)request.getAttribute("linesetName");
         String testerFam=(String)request.getAttribute("testerFam");
...
<%--@ include file="/test/reqParAndAttr.jsp" --%>
...
<%@ include file="top.jsp" %>
	    ...
	    <FORM name="selDirForm" action="navDirServlet" method="post">
         ...
         <INPUT TYPE="HIDDEN" name="initDirPath" value="<%= ((request.getParameterValues("initDirPath")==null)||(request.getParameterValues("initDirPath")[0].equals("WORK_DIR")) ? "WORK_DIR" : "HOME_DIR") %>">
             ...
             <INPUT TYPE="HIDDEN" NAME="linesetName" VALUE="<%= linesetName %>">
             <INPUT TYPE="HIDDEN" NAME="testerFam" VALUE="<%= testerFam %>">
