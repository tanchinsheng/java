...
//				result = (Integer) res;
	...
	{	
		...
		try
		{
			...
			Connection connectionIEDB = null;
			try 
			{
                connectionIEDB = IEDBConnectionManager.getConnection();
				AtomRTMIedb atomRTMIedb = new AtomRTMIedb(connectionIEDB);	
                //should use connectionIEDB directiy in query method.
			...
			{
                IEDBConnectionManager.closeConnection(connectionIEDB);
			}
