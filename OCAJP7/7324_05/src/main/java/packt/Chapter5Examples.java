...
//        }
    ...
    private static void breakStatementExample() {
        ...
        while (true) {
            ...
            // equals method is executed against the string literal
            // and the command is used as its argument
            // This approach avoids NPE
...
//        Scanner scanner = new Scanner(System.in);
    ...
    private static void whileLoopExamples() {
        ...
        System.out.print("Enter a number: ");
        number = scanner.nextInt();
        // The while statement is useful for loops where the number of
        // loop iterations required is not known.
        // evaluation of the expression at the beginning of the loop
        // body of the loop may never be executed if the
        // first evaluation of the logical expression evaluates to false
        while (number > 0) {
            sum += number;
            System.out.print("Enter a number: ");
            number = scanner.nextInt();
