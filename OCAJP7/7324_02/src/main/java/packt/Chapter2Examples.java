...
public class Chapter2Examples {
    ...
    public static void main(String[] args) {
        ...
        if (s1 == s2) {
            // False
            //The if statement is comparing string reference variables and not the actual
            //strings. As they are referencing different objects, the comparison returns false. It all
            //depends on how the compiler and run-time system handles the strings internally.
