...
<!-- REPORT -->
<%
        xmlRdr.applyXSL((Document)request.getAttribute("dirContentXml"), config.getServletContext().getInitParameter("webAppDir")+"/navDir.xsl", out);
%>
		    ...
		    <td align="right">
     		     <TABLE CELLSPACING="0" CELLPADDING="0" BORDER="0">
       		      <TR>
                       ...
                       <TD valign="center" background="img/btn_center.gif" class="testo"><A CLASS="BUTTON" HREF="javascript:gotoDir()">GO TO DIRECTORY</a></TD>
