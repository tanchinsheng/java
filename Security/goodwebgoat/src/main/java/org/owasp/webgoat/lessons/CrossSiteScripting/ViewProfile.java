            ...
            try {
                ...
                if (answer_results.next()) {
                    ...
                    profile = new Employee (answer_results.getInt("userid"), 
                            HtmlEncoder.encode(answer_results.getString("first_name")),
                            HtmlEncoder.encode(answer_results.getString("last_name")), 
                            HtmlEncoder.encode(answer_results.getString("ssn")), 
                            HtmlEncoder.encode(answer_results.getString("title")), 
                            HtmlEncoder.encode(answer_results.getString("phone")), 
                            HtmlEncoder.encode(answer_results.getString("address1")), 
                            HtmlEncoder.encode(answer_results.getString("address2")), 
                            answer_results.getInt("manager"), 
                            HtmlEncoder.encode(answer_results.getString("start_date")), 
                            answer_results.getInt("salary"), 
                            HtmlEncoder.encode(answer_results.getString("ccn")), 
                            answer_results.getInt("ccn_limit"), 
                            HtmlEncoder.encode(answer_results.getString("disciplined_date")), 
                            HtmlEncoder.encode(answer_results.getString("disciplined_notes")), 
                            HtmlEncoder.encode(answer_results.getString("personal_description")));
                    /* End Good Code */
