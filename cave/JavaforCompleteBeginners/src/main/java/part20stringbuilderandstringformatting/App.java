 ...
 */
package part20stringbuilderandstringformatting;

/**
 * How to use StringBuilder, StringBuffer and why you should use them. This
 * video also unveils the mystery of formatting strings with printf() and
 * related methods; vital skills for any Java course or aspiring software
 * developer.
 */
public class App {
