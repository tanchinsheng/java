...
public class LsAlignFileDiffAction extends LsAction {

    public LsAlignFileDiffAction(String action, LogWriter log) {
        super(action, log);
    ...
    public void writeBackEndInFile(String SID, String fName, String repFileName) throws IOException, Exception {
        ...
        out.println("file_path=" + xmlRdr.getVal(lsRec, "FILE_PATH"));
        out.println("baseline1=" + xmlRdr.getVal(lsRec, "BASELINE1"));
        out.println("baseline2=" + xmlRdr.getVal(lsRec, "BASELINE2"));
