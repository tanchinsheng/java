...
package part26polymorphism;

/**
This is a tutorial on polymorphism; a big word for a fairly simple but very useful concept, 
* without which object-oriented programming would be a lot trickier.
 */
public class App {
