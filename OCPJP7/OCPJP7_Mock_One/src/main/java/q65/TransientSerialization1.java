...
class USPresident1 implements Serializable {
    ...
    public USPresident1(String name, String period, String term) {
        this.name = name;
        this.period = period;
        this.term = term;
    }
...
public class TransientSerialization1 {

    public static void main(String[] args) {
        USPresident1 usPresident = new USPresident1("Barack Obama", "2009 to --", "56th term");
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("USPresident.data"))) {
            ...
            if (obj != null && obj instanceof USPresident1) {
                USPresident1 presidentOfUS = (USPresident1) obj;
