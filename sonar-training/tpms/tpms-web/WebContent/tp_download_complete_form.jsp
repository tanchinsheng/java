...
<BODY bgColor="#FFFFFF">
<% boolean repBool=false; boolean csvRepBool=false; String pageTitle="TP DOWNLOAD FORM"; %>
<%@ include file="top.jsp" %>
          ...
          <FORM name="changeDirForm" action="navDirServlet" method="post">
 	      <INPUT TYPE="HIDDEN" name="pageTitle" value="TP DOWNLOAD FORM -> TARGET DIR SELECTION">
 	      <INPUT TYPE="HIDDEN" name="nextPage" value="tp_action_seldir.jsp">
 	      <INPUT TYPE="HIDDEN" name="outPage" value="tp_download_complete_form.jsp">
	    ...
	    <FORM name="tpActionForm" action="tpActionServlet" method="post">
             ...
             <INPUT TYPE="HIDDEN" NAME="action" VALUE="tp_download_complete">
             <INPUT TYPE="HIDDEN" NAME="repFileName" VALUE="<%= repFileName %>">
             <INPUT TYPE="HIDDEN" NAME="jobname" VALUE="<%= jobname %>">
             <INPUT TYPE="HIDDEN" NAME="job_rel" VALUE="<%= job_rel %>">
             <INPUT TYPE="HIDDEN" NAME="job_rev" VALUE="<%= job_rev %>">
		...
		<tr>
     		  ...
     		  <TABLE CELLSPACING="0" CELLPADDING="0" BORDER="0">
       		   <TR>
                    ...
                    <TD valign="center" align="right" background="img/btn_center.gif" class="testo"><A CLASS="BUTTON" HREF="javascript:changeDir()">CHANGE DIR</TD>
