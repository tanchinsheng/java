...
<% boolean repBool=false; boolean csvRepBool=false; String pageTitle="TP PUT IN PRODUCTION "+(startBool ? "IN PROGRESS" : "RESULT"); %>
...
<%
 ...
 {%>
   <%
    ...
    String msgTxt    = "TP FILES SUCCESSFULLY UPLOADED";
    String detailTxt = "";
    String sysDetailTxt = "";
