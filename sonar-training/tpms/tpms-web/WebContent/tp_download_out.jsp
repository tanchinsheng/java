...
<% boolean repBool=false; boolean csvRepBool=false; String pageTitle="TP FILES DOWNLOAD "+(startBool ? "IN PROGRESS" : "RESULT"); %>
...
<%
 ...
 {%>
   <%
    ...
    String msgTxt    = "TP FILES SUCCESSFULLY DOWNLOADED";
    String detailTxt = "UNDER $HOME/TPMSw_downloaded_files DIRECTORY";
    String sysDetailTxt = "";
