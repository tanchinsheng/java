...
<%
    ...
    String secondFieldName = request.getParameter("field2");
    String fieldName1;
    String fieldName2;
    if (GeneralStringUtils.isEmptyString(secondFieldName)) {
        fieldName1 = (firstFieldName.endsWith(".min") ? firstFieldName : (firstFieldName.endsWith(".max") ? null : firstFieldName +".min"));
        fieldName2 = (firstFieldName.endsWith(".max") ? firstFieldName : (firstFieldName.endsWith(".min") ? null : firstFieldName +".max"));
    } else {
        fieldName1 = firstFieldName;
        fieldName2 = secondFieldName;
    }
...
<SCRIPT language=JavaScript>
 function submitForm()
 {
   ...
   <% if (fieldName2!=null)
      {%>
        topwin.document.<%= formName %>.elements['<%= fieldName2 %>'].value=document.dateSelForm.elements['<%= fieldName2 %>'].value;
      <%}
   %>
   window.close();
 }

 function calPopup(field)
 {
  var url = "cal_popup.jsp";
  url = addSessionInformation(url,null);
  var popup = window.open(url + '&field=' + field, 'EPCalPopup' + field, 'width=630,height=455,resizable=yes,scrollbars=no,status=0');
...
function setDate(i, str) 
{
 ...
 str=trim(str);
 mnth1 = (i==1 ? document.dateSelForm.month1.value : document.dateSelForm.month2.value);
 mnth = mnth1;
 year = (i==1 ? document.dateSelForm.year1.value : document.dateSelForm.year2.value);
 dateStr = (str.length<2 ? "0"+str : str)+"/"+getMonthLab(mnth)+"/"+year;
 dateStr = trim(dateStr);
 mnth++;
 
 if (i==1) document.dateSelForm.elements['<%= fieldName1 %>'].value = dateStr;
 else document.dateSelForm.elements['<%= fieldName2 %>'].value = dateStr;
...
function thisMonth() {
  ...
  document.dateSelForm.month2.value = mnth;
  document.dateSelForm.year2.value = yr;
  document.dateSelForm.currMonth2.value = mnth;
  document.dateSelForm.currYear2.value = yr;

  document.dateSelForm.monthYear1.value = mnthName+yr;
  document.dateSelForm.monthYear2.value = mnthName+yr;

  //document.dateSelForm.<%= fieldName1 %>.value = dayOfMnth+"/"+(mnth+1)+"/"+yr;
  //document.dateSelForm.<%= fieldName2 %>.value = dayOfMnth+"/"+(mnth+1)+"/"+yr;
  ...
  fillDates(2,dayOfWeek1+1,noOfDaysInMnth);
...
function prevMonth(i) 
{
 ...
 runningMonth = document.dateSelForm.currMonth.value;
 rMonth=runningMonth;
 rMonth++;
 runningYear = document.dateSelForm.currYear.value;
 rYear=runningYear;
...
{%>
 ...
 <TABLE border=0 cellPadding=0 cellSpacing=0 width=290'>
  ...
  <TR>
    ...
    <TD align=middle background=img/tit_center.gif class=titverdi noWrap><B><!-- FORM TITLE-->FROM DATE</B></TD>
...
{%>
 ...
 <TABLE border=0 cellPadding=0 cellSpacing=0 width=290>
  ...
  <TR>
    <TD width=4><IMG alt="" border=0 height=18 src="img/tit_sx.gif" width=4></TD>
    <TD align=middle background=img/tit_center.gif class=titverdi noWrap><B><!-- FORM TITLE-->TO DATE</B></TD>
    <TD width=4><IMG alt="" border=0 height=18 src="img/tit_dx.gif" width=4></TD>
    <TD><IMG alt="" border=0 height=18 src="img/pix.gif" width=263></TD></TR>
  <TR>
    <TD colSpan=4><IMG alt="" border=0 height=1 src="img/pix_grey.gif" width=290></TD>
  </TR>
  <TR>
...
<INPUT name=currMonth2 type=hidden> <INPUT name=currYear2 type=hidden> 
<TR>
<% if (fieldName1!=null)
{%>
<TD ALIGN="LEFT">
<TABLE bgColor=#d4d4d4 border=1 cellPadding=0 cellSpacing=0 width=280>
  ...
  <TR>
    ...
    <INPUT class="txtnob" maxlength="100" size="11"  name="monthYear1"> 
  ...
  <TR>
    ...
    <TD align=middle><INPUT name=s42 onclick="setDate(1, this.value);" type=button value="   "></TH> 
    </TD></TR></TBODY></TABLE>
<TABLE border=0 cellPadding=0 cellSpacing=0 width=280>
  ...
  <TR>
    <TD align=right class=testonoline><B>From date</B> 
      <INPUT class="txt" maxlength="100" size="11" name="<%= fieldName1 %>"> 
    </TD>
  </TR>
  </TBODY>
</TABLE>
...
<TABLE bgColor=#d4d4d4 border=1 cellPadding=0 cellSpacing=0 width=280>
  <TBODY>
  <TR>
    <TD align=center  class="testonoline" bgColor=#c9e1fa colSpan=7 vAlign=top><IMG border=0 height=12 src="img/pix.gif"> 
    <INPUT name=prev onclick=prevMonth(2) type=button value="<<">
    <INPUT class="txtnob" maxlength="100" size="11" name=monthYear2>
    <INPUT name=next onclick=nextMonth(2) type=button value=">>"> <IMG 
      border=0 height=12 src="img/pix.gif"> </TD></TR>
  <TR bgColor=#000080>
    <TD width="14%"><FONT color=#ffffff size=2><STRONG>SUN</STRONG></FONT></TD>
    <TD width="14%"><FONT color=#ffffff size=2><STRONG>MON</STRONG></FONT></TD>
    <TD width="14%"><FONT color=#ffffff size=2><STRONG>TUE</STRONG></FONT></TD>
  ...
  size=2><STRONG>SAT</STRONG></FONT></TD></TR>
  <TR>
    <TD align=middle width="14%"><INPUT name=ss1 onclick="setDate(2, this.value);" type=button value=" 1 "></TD>
    <TD align=middle width="14%"><INPUT name=ss2 onclick="setDate(2, this.value);" type=button value=" 2 "></TD>
    <TD align=middle width="14%"><INPUT name=ss3 onclick="setDate(2, this.value);" type=button value=" 3 "></TD>
    <TD align=middle width="14%"><INPUT name=ss4 onclick="setDate(2, this.value);" type=button value=" 4 "></TD>
    <TD align=middle width="14%"><INPUT name=ss5 onclick="setDate(2, this.value);" type=button value=" 5 "></TD>
    <TD align=middle width="15%"><INPUT name=ss6 onclick="setDate(2, this.value);" type=button value=" 6 "></TD>
    <TD align=middle width="15%"><INPUT name=ss7 onclick="setDate(2, this.value);" type=button value=" 7 "></TD></TR>
  <TR>
    <TD align=middle width="14%"><INPUT name=ss8 onclick="setDate(2, this.value);" type=button value=" 8 "></TD>
    <TD align=middle width="14%"><INPUT name=ss9 onclick="setDate(2, this.value);" type=button value=" 9 "></TD>
    <TD align=middle width="14%"><INPUT name=ss10 onclick="setDate(2, this.value);" type=button value=10></TD>
    <TD align=middle width="14%"><INPUT name=ss11 onclick="setDate(2, this.value);" type=button value=11></TD>
    <TD align=middle width="14%"><INPUT name=ss12 onclick="setDate(2, this.value);" type=button value=12></TD>
    <TD align=middle width="15%"><INPUT name=ss13 onclick="setDate(2, this.value);" type=button value=13></TD>
    <TD align=middle width="15%"><INPUT name=ss14 onclick="setDate(2, this.value);" type=button value=14></TD></TR>
  <TR>
    <TD align=middle width="14%"><INPUT name=ss15 onclick="setDate(2, this.value);" type=button value=15></TD>
    <TD align=middle width="14%"><INPUT name=ss16 onclick="setDate(2, this.value);" type=button value=16></TD>
    <TD align=middle width="14%"><INPUT name=ss17 onclick="setDate(2, this.value);" type=button value=17></TD>
    <TD align=middle width="14%"><INPUT name=ss18 onclick="setDate(2, this.value);" type=button value=18></TD>
    <TD align=middle width="14%"><INPUT name=ss19 onclick="setDate(2, this.value);" type=button value=19></TD>
    <TD align=middle width="15%"><INPUT name=ss20 onclick="setDate(2, this.value);" type=button value=20></TD>
    <TD align=middle width="15%"><INPUT name=ss21 onclick="setDate(2, this.value);" type=button value=21></TD></TR>
  <TR>
    <TD align=middle width="14%"><INPUT name=ss22 onclick="setDate(2, this.value);" type=button value=22></TD>
    <TD align=middle width="14%"><INPUT name=ss23 onclick="setDate(2, this.value);" type=button value=23></TD>
    <TD align=middle width="14%"><INPUT name=ss24 onclick="setDate(2, this.value);" type=button value=24></TD>
    <TD align=middle width="14%"><INPUT name=ss25 onclick="setDate(2, this.value);" type=button value=25></TD>
    <TD align=middle width="14%"><INPUT name=ss26 onclick="setDate(2, this.value);" type=button value=26></TD>
    <TD align=middle width="15%"><INPUT name=ss27 onclick="setDate(2, this.value);" type=button value=27></TD>
    <TD align=middle width="15%"><INPUT name=ss28 onclick="setDate(2, this.value);" type=button value=28></TD></TR>
  <TR>
    <TD align=middle><INPUT name=ss29 onclick="setDate(2, this.value);" type=button value=29></TD>
    <TD align=middle><INPUT name=ss30 onclick="setDate(2, this.value);" type=button value=30></TD>
    <TD align=middle><INPUT name=ss31 onclick="setDate(2, this.value);" type=button value="   "></TD>
    <TD align=middle><INPUT name=ss32 onclick="setDate(2, this.value);" type=button value="   "></TD>
    <TD align=middle><INPUT name=ss33 onclick="setDate(2, this.value);" type=button value="   "></TD>
    <TD align=middle><INPUT name=ss34 onclick="setDate(2, this.value);" type=button value="   "></TD>
    <TD align=middle><INPUT name=ss35 onclick="setDate(2, this.value);" type=button value="   "></TD></TR>
  <TR>
    <TD align=middle><INPUT name=ss36 onclick="setDate(2, this.value);" type=button value="   "></TD>
    <TD align=middle><INPUT name=ss37 onclick="setDate(2, this.value);" type=button value="   "></TD>
    <TD align=middle><INPUT name=ss38 onclick="setDate(2, this.value);" type=button value="   "></TD>
    <TD align=middle><INPUT name=ss39 onclick="setDate(2, this.value);" type=button value="   "></TD>
    <TD align=middle><INPUT name=ss40 onclick="setDate(2, this.value);" type=button value="   "></TD>
    <TD align=middle><INPUT name=ss41 onclick="setDate(2, this.value);" type=button value="   "></TD>
    <TD align=middle><INPUT name=ss42 onclick="setDate(2, this.value);" type=button value="   "></TH> 
    </TD>
  </TR>
  </TBODY>
</TABLE>
<TABLE border=0 cellPadding=0 cellSpacing=0 width=280>
  ...
  <TR>
    <TD align=right class=testonoline><B>To date</B>
      <INPUT class="txt" maxlength="100" size="11" name="<%= fieldName2 %>">
    </TD>
  </TR>
  </TBODY>
</TABLE>
...
%>
                ...
                <tr>
                  <td colspan="<%= ((fieldName1==null)||(fieldName2==null) ? "1" : "2") %>"><img src="img/pix.gif" height="2" alt="" border="0"></td>
                </tr>
                <tr>
                  <td colspan="<%= ((fieldName1==null)||(fieldName2==null) ? "1" : "2") %>"><img src="img/pix_nero.gif" width="<%= ((fieldName1==null)||(fieldName2==null) ? "315" : "630") %>" height="1" alt="" border="0"></td>
                </tr>
		<tr>
                 <td  colspan="<%= ((fieldName1==null)||(fieldName2==null) ? "1" : "2") %>" align="right">
     		  <TABLE CELLSPACING="0" CELLPADDING="0" BORDER="0">
       		   <TR>
                      <TD valign="top"><IMG SRC="img/btn_left.gif"></TD>
                      <TD valign="top" background="img/btn_center.gif" class="testo"><A CLASS="BUTTON" HREF="javascript:submitForm()">SUBMIT</A></TD>			
