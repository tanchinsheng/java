...
//	private static Logger _logger = Logger.getLogger(AtomUtil.class.getName());
    ...
    public BeanLastRun selectLastRun(BeanRTMHeader ttHeader) throws TechnicalException 
	{
	...
	public BeanGlobalSettings selectGlobalSetting() throws TechnicalException 
	{
		StringBuffer sql= new StringBuffer("");
		String sqlStr = "";
