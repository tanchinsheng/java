 ...
 * Date: 30-gen-2006
 * Time: 14.08.59
 * This class is usefull to execute a system command.
 */
public class ClearcaseCommand implements Runnable {
     ...
     */
    public ClearcaseCommand(String command, boolean waitResult) {
     ...
     */
    public ClearcaseCommand(String command) {
        this.command = command;
