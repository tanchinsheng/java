...
<%
 String selFile=(String)request.getParameterValues("lsFile")[0];
 int index  = selFile.lastIndexOf("/");
 String fileName = selFile.substring(index+1);
         ...
         <BR>
              <table cellpadding="0" cellspacing="0" border="0" width="924" >
                <tr>
                  ...
                  <td background="img/tit_center_file.gif" align="center" class="titverdi" nowrap><b><!-- FORM TITLE-->FILE "</b><font color="#19559E" face="Courier"><%= fileName %></b><b>" DIFFERENCES</b></FONT></td>
