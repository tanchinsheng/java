...
public class app {
    ...
    public static void main(String[] args) {
        ...
        C2 o2;
        C3 o3;
        o3 = o1;// superclass reference cannot be assigned to subclass
        // reference without explicit cast.
        o3 = o2; //There is no way a reference of class C2 (which is o2)
        // can point to an object of class C3
        // because C2 and C3 have no inheritance relationship.
        // So this assignment is rejected at compile time itself.
        I1 i1 = o3; //legal
        I2 i2 = (I2) i1; //legal
        //This is valid because at run time i1 actually refers to an object
        //that implements I2.
        I1 b = o3; //legal
