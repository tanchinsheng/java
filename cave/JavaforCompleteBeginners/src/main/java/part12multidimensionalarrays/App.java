package part12multidimensionalarrays;
/**
How to work with multi-dimensional arrays in Java and info on how multi-dimensional arrays 
* actually work, plus some tips on how to remember which index is which.
 */
public class App {
