...
class SumOfNUsingForkJoin1 {

    private static final long N = 1000_000; // one million - we want to compute sum
    // from 1 .. one million
    private static final int NUM_THREADS = Runtime.getRuntime().availableProcessors(); // number of threads to create for
