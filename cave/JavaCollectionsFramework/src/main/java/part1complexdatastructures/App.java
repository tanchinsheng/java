 ...
 */
package part1complexdatastructures;

/**
You can build up arbitrarily complicated data structures in Java using the Collections framework classes.
* We’ll take a look at a simple example in this tutorial.
 */
