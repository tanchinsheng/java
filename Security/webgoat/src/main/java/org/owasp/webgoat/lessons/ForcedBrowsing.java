...
public class ForcedBrowsing extends LessonAdapter
{
	...
	protected Element createContent(WebSession s)
	{
		...
		{
			ec
					.addElement("Can you try to force browse to the config page which should only be accessed by maintenance personnel. Hint: Change URL to http://sglx481.amk.st.com:11080/WebGoat/conf.");
		}
		return ec;
	}
