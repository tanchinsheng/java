...
import com.st.mcc.rtm.dao.manager.StConnectionManager_IEDB;
...
//				result = (Integer) res;
	...
	{	
		...
		try
		{
			...
			try 
			{
				connection_IEDB = StConnectionManager_IEDB.getInstance().getConnection();
			...
			{
				StConnectionManager_IEDB.getInstance().freeConnection(connection_IEDB);
			}
