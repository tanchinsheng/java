...
class BlockerQueue {
    ...
    private final Condition empty = internalLock.newCondition();

    // condition to wait for when queue is full that makes use of the common lock
    private final Condition full = internalLock.newCondition();
    ...
    public Object remove() {
        ...
        try {
            ...
            System.out.println("In remove(): --currPointer " + currPointer);
    ...
    public void insert(Object element) {
        ...
        try {
            ...
            // set the element and after that increment the currPointer
            System.out.println("In insert(): currPointer++ " + currPointer);
