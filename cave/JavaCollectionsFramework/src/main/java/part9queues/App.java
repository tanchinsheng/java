...
/**
A tutorial on the Java Queue interface, plus a couple of examples of Queues and a bit 
* about the highly-useful (if you’re into multithreading) BlockingQueue interface
 */
