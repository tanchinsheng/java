...
<%
    ...
    Element tpRecord = (Element) request.getAttribute("tpRec");
    String productionArea = TpUtils.tpDisplayProductionArea( tpRecord );
%>
...
<HEAD>
  ...
  <SCRIPT language=JavaScript>
   ...
   {
     if(!putInProdActionComm()) return;
     document.tpActionForm.submit();
   }
   function putInProdActionComm(){
   		var  putInProdActionComm = document.tpActionForm.putInProdCmt.value;
     	if (putInProdActionComm != "") {	
	    	if (filterSpecialChar(putInProdActionComm) == false) {
...
<BODY bgColor="#FFFFFF">
<% boolean repBool=false; boolean csvRepBool=false; String pageTitle="TP PUT IN PRODUCTION FORM"; %>
             ...
             <INPUT TYPE="HIDDEN" NAME="job_ver" VALUE="<%= job_ver %>">
                    <table cellspacing=0 cellpadding=0 width="70%" border=0 >
                      ...
                      <tr>
                        ...
                        <td class=testo width="40%">
							<b>Production Area</b><br> <%=productionArea%>
                        </td>

                        <!-- COLUMN SEPARATOR --><td>&nbsp;</td><td>&nbsp;</td><!-- /COLUMN SEPARATOR -->

                        <td class=testo width="40%"><b>TP owner email</b><br>
                         <%= ownerEmail %>
			 			<input type="hidden" name="fromEmail" value="<%= fromEmail %>"></td>
			  ...
			  <option value="" selected>
			   <%
			    ...
			    <%} %>
                      ...
                      <!-- INTER ROWS SPACE -->
                      <tr>
                       <td colspan=5><img alt="" src="img/blank.gif"  border=0>
                      ...
                      <tr>
                        ...
                        <td class=testo colspan="5">
                         <b>CC email</b><br>
                         <input maxlength="256" size="70" name="ccEmail" value="">
                      ...
                      <tr><td colspan=5><img alt="" src="<%=contextPath%>/img/blank.gif"  border=0></td></tr>
                       <tr>
                        ...
                        <td class=testo width="40%" valign="top" colspan="4">
                         ...
                         <textarea name="putInProdCmt" rows="4" cols="60" WRAP=PHYSICAL value=""></textarea>                        
                        </td>
                        <!-- RIGHT COLUMN SEPARATOR --><td>&nbsp;</td><!-- /RIGHT COLUMN SEPARATOR -->
                      </tr>
                      <tr>
